...
def save_diagnose_form(request, form, template_name):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            data['html_diagnose_list'] = render_to_string("malaika/includes/partial_diagnose_list.html",
                {'diagnoses': diagnoses}
            )
        else:
...
def diagnose_create(request):
    if request.method == 'POST':
        ...
        form = DiagnoseForm()
    return save_diagnose_form(request, form, 'malaika/diagnose_form.html')
...
def diagnose_update(request, pk):
    ...
    return save_diagnose_form(request, form, 'malaika/diagnose_update.html')
...
def diagnose_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        data['html_form'] = render_to_string('malaika/diagnose_delete.html',
            context,
            request=request,
        )
    return JsonResponse(data)
...
def save_room_form(request, form, template_name):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            data['html_room_list'] = render_to_string('malaika/includes/partial_room_list.html',
                {'rooms': rooms}
            )
        else:
            data['form_is_valid'] = False
...
def room_create(request):
    if request.method == 'POST':
        ...
        form = RoomForm()
    return save_room_form(request, form, 'malaika/room_form.html')
...
def room_update(request, pk):
    ...
    return save_room_form(request, form, 'malaika/room_update.html')
...
def room_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        context = {'room': room}
        data['html_form'] = render_to_string('malaika/room_delete.html',
            context,
            request=request,
        )
    return JsonResponse(data)
...
class DiagnoseListView(LoginRequiredMixin, ListView):
    ...
    model = Diagnose
    template_name = 'malaika/diagnose_list.html'
...
class RoomListView(LoginRequiredMixin, ListView):
    ...
    model = Room
    template_name = 'malaika/room_list.html'
